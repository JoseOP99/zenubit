    ...
    <footer>
      <div className="container footer-grid">
        <div className="footer-brand">
          <span className="nav-wordmark" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px' }}>
            <span className="glow-node" style={{ position: 'relative', top: 'auto', left: 'auto', transform: 'none', width: '8px', height: '8px' }}></span>
            Zenubit
          </span>
        ...
        <div>
          ...
          <ul className="footer-links">
            <li style={{ color: 'var(--cream-dim)' }}>Tuchín &middot; Córdoba &middot; Colombia</li>
          </ul>
        </div>
      </div>
      ...
      <div className="container footer-bottom">
        ...
        <div className="footer-bottom-meta">
          ...
          <a href="https://www.facebook.com/profile.php?id=61579270679642" target="_blank" rel="noopener noreferrer" className="footer-social-icon" title="Facebook" aria-label="Facebook">
            <svg viewBox="0 0 24 24">
